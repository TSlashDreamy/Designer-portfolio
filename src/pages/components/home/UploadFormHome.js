...
import "./../../../App.css";
import ProgressBar from "./ProgressBarHome";
...
const UploadForm = () => {
  ...
  return (
    <form>
      <Tooltip TransitionComponent={Zoom} title="Не забывайте назвать по другому свой файл для секции последних работ, что-бы избежать проблем прогурзки изображений в других секциях!" arrow>
      <motion.label
