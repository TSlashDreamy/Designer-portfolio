...
function MainNav() {
    ...
    const cooplink = link.replace('home', 'danyasignupcooperationHzGkeaAU0hXYpn');
    ...
    function copy() {
        navigator.clipboard.writeText(cooplink)
        setCopied(true);
    ...
    return (
      ...
      {notify && <Snackbar anchorOrigin={{ vertical, horizontal }} open={openSuccess} autoHideDuration={6000} onClose={handleClose}>
        ...
        <Toolbar>
          ...
          <FontAwesomeIcon onClick={handleClick} icon={["fab", "dyalog"]} className={classes.logo}/>
            danya    
          </Typography>
            <div>
          {currentUser ? <>
          ...
          <Tooltip TransitionComponent={Zoom} placement="left" title="Я - владелец сайта" arrow>
            ...
            <MenuIcon />
              ...
              >
                ...
                <Link onClick={handleCloseMenu} to="categories" spy={true} smooth={true}><MenuItem>Категории</MenuItem></Link>
                <Link onClick={handleCloseMenu} to="lastWorks" spy={true} smooth={true}><MenuItem>Последние работы</MenuItem></Link>
                <Link onClick={handleCloseMenu} to="footer" spy={true} smooth={true}><MenuItem>Контакты</MenuItem></Link>
