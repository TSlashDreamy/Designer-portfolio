...
function Signup() {
  ...
  async function handleSubmit(e) {
    ...
    if (emailRef.current.value === "") {
      ...
      return setError("Вы не повторили пароль!")
    }
          ...
          <form onSubmit={handleSubmit} className={classes.form} noValidate>
            ...
            <Grid container>
              ...
              <div className={classes.text} href="https://tflashgamer.github.io/production/#/home" variant="body2">
                ...
                <br />
                <div className={classes.text} href="https://tflashgamer.github.io/production/#/home" variant="body2">
                  Вы сотрудник и у Вас уже есть аккаунт? <ReactLink className={classes.link} to="/login">Тогда просто войдите в него 😉</ReactLink>
                </div>
              </Grid>
            </Grid>
            <Box mt={5}>
